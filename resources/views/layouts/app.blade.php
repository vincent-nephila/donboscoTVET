...
<div class="wrapper">
  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      ...
      <strong><i class="fa fa-copyright" aria-hidden="true"></i> Reserved for 2017 - {{date('Y')}}</strong>
  </footer>
  ...
  <div class="control-sidebar-bg"></div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    An error has occured while processing your data. This has already been emailed to the Admin. If fix requires urgent attention please contact the administrator
                </div>
                <!-- /.modal-content -->
            </div>
            <!-- /.modal-dialog -->
    ...
    <div class="modal fade" id='user-warnig'>
